...
vec3 sample_area_polygon_turk(uint vertex_count, vec3 vertices[MAX_POLYGON_VERTEX_COUNT], vec2 random_numbers) {
	...
	return barycentric[0] * vertices[0] + barycentric[1] * vertices[1] + barycentric[2] * vertices[2];
}
